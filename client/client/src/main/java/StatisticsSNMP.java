...
public class StatisticsSNMP extends javax.swing.JFrame {
    DefaultTableModel tableModel;

    public StatisticsSNMP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mainLabel.setText("SNMP Group Statistics");
        ...
        getDataButton.setText("Get SNMP Group Statistics");
    ...
    private void createTable() {
        ...
        try {
            // Create the URL
            URL url = new URL("http://localhost/php2/page4.php");
